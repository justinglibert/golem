"""
Distributed stuff. Basically wrappers around torch.distributed
Directly stolen from machin (kudos to Ifft for making such a nice wrapper around Pytorch RPC)
"""
